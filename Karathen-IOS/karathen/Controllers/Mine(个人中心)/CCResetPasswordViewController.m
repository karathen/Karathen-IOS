...
- (void)changeHardwarePwd {
    ...
    @weakify(self)
    [[CCHardwareWallet hardwareWallet] changePassword:self.passwordView.text oldPassWord:self.oldPwView.text deviceWaiting:^{
        @strongify(self)
        self.alertView.message = Localized(@"Press button to change password");
